import {
    TextField, Button, Box, Avatar, Typography, Container,
    CircularProgress, Backdrop, CssBaseline, Autocomplete, Chip
} from '@mui/material';
...
const CreatePoll = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            enqueueSnackbar(`Getting error while creating poll: ${error}`, { variant: 'error', autoHideDuration: 5000 });
        } finally {
            setLoading(false);
        }
    };
